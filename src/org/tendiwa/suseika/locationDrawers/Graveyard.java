...
//		ArrayList<SideTest> sides = new ArrayList<SideTest>();
//		ArrayList<SideTest> outerSides = mainRS.outerSides.get(cryptRecNum);
//		for (int i = 1; i < 5; i++) {
//			if (!outerSides.contains(SideTest.int2side(i))) {
//				sides.add(SideTest.int2side(i));
//			}
//		}
