...
//		terrainModifier.drawInnerBorders(Location.ELEMENT_OBJECT, wallGreyStone);
		...
		rs = RecursivelySplitRectangleSystemFactory.create(x, y, width, height, 1, 1);
//		rs = new RectangleSystem(1);
...
//		rs.excludeRectangle(rs.getRectangleById(39));
		...
		terrainModifier = settlement.getTerrainModifier(rs);
		terrainModifier.drawInnerBorders(ObjectTypes.wall_grey_stone);
		terrainModifier.drawOuterBorders(ObjectTypes.wall_grey_stone);
